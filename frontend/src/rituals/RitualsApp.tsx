...
export default function RitualsApp({ characters }: { characters: any[] }) {
  ...
  return (
    <div className="gods:h-full gods:flex gods:bg-background gods:text-foreground gods:font-[family-name:var(--font-body)] gods:overflow-hidden">
      ...
      {/* Sidebar - Navigation */}
      <aside className="gods:w-72 gods:shrink-0 gods:border-r gods:border-border gods:flex gods:flex-col gods:bg-card/40 gods:z-10 gods:overflow-y-auto">
        <div className="gods:p-5 gods:border-b gods:border-border">
          <h1 className="gods:font-[family-name:var(--font-display)] gods:text-xl gods:tracking-widest gods:uppercase gods:text-foreground">
            Grimoire
          </h1>
          <p className="gods:text-sm gods:text-foreground/50 gods:mt-1">Magie et sacrifices</p>
        </div>
        ...
        <nav className="gods:p-3 gods:space-y-1">
          ...
          >
            <BookOpen size={18} />
            <span className="gods:font-[family-name:var(--font-display)] gods:tracking-wide gods:text-base">Règles et Usages</span>
          </button>

          <div className="gods:my-4 gods:px-3 gods:text-xs gods:font-[family-name:var(--font-display)] gods:tracking-[0.2em] gods:uppercase gods:text-foreground/40">
              ...
              <button
                ...
                className={`gods-ritual-tab gods:w-full gods:flex gods:items-center gods:justify-between gods:px-3 gods:py-2.5 gods:rounded-md gods:transition-colors !gods:outline-none focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0 ${
                  activeCategory === category.id 
                    ...
                    : "gods:text-foreground/60 hover:gods:bg-muted/50 hover:gods:text-foreground gods:border gods:border-transparent"
                }`}
              >
                <div className="gods:flex gods:items-center gods:gap-3">
                  ...
                  <span className="gods:font-[family-name:var(--font-display)] gods:tracking-wide gods:text-base">{category.title}</span>
                </div>
                {activeCategory === category.id && <ChevronRight size={14} className="gods:text-foreground/30" />}
              </button>
            );
          })}
        </nav>
        ...
        <div className="gods:max-w-4xl gods:mx-auto">
          ...
          {activeCategory === "rules" && (
            <div className="gods:animate-in gods:fade-in gods:slide-in-from-bottom-4 gods:duration-500">
              <h2 className="gods:font-[family-name:var(--font-display)] gods:text-3xl gods:tracking-widest gods:uppercase gods:text-foreground gods:mb-6">
                Comment débloquer et utiliser un Rituel
              </h2>
              
              <div className="gods:space-y-6 gods:text-lg gods:text-foreground/80 gods:leading-relaxed">
                <div className="gods:bg-card gods:border gods:border-border gods:rounded-lg gods:p-6">
                  <h3 className="gods:font-[family-name:var(--font-display)] gods:text-primary gods:text-xl gods:mb-3">Utilisation et Alimentation</h3>
                ...
                <div className="gods:bg-card gods:border gods:border-border gods:rounded-lg gods:p-6">
                  <h3 className="gods:font-[family-name:var(--font-display)] gods:text-primary gods:text-xl gods:mb-3">Réceptacles & Niveaux</h3>
                ...
                <div className="gods:bg-card gods:border gods:border-border gods:rounded-lg gods:p-6">
                  <h3 className="gods:font-[family-name:var(--font-display)] gods:text-primary gods:text-xl gods:mb-3">Élus et Résolution</h3>
          ...
          {activeData && (
            <div className="gods:animate-in gods:fade-in gods:slide-in-from-bottom-4 gods:duration-500">
              <div className="gods:flex gods:items-center gods:gap-4 gods:mb-8 gods:border-b gods:border-border gods:pb-4">
                ...
                <h2 className="gods:font-[family-name:var(--font-display)] gods:text-3xl gods:tracking-widest gods:uppercase gods:text-foreground">
                  {activeData.title}
                </h2>
              </div>
                ...
                {activeData.rituals.map((ritual, idx) => (
                  <div key={idx} className="gods:bg-card gods:border gods:border-border gods:rounded-lg gods:overflow-hidden gods:transition-all hover:gods:border-primary/40 hover:gods:shadow-lg hover:gods:shadow-background">
                    ...
                    <div className="gods:flex gods:items-center gods:justify-between gods:bg-muted/30 gods:px-5 gods:py-4 gods:border-b gods:border-border">
                      <div className="gods:flex gods:items-center gods:gap-3">
                        <h3 className="gods:font-[family-name:var(--font-display)] gods:text-xl gods:text-foreground gods:tracking-wide">
                          {ritual.name}
                        </h3>
                        <span className={`gods:text-[11px] gods:px-2 gods:py-0.5 gods:rounded gods:font-[family-name:var(--font-display)] gods:uppercase gods:tracking-widest gods:border ${
                      ...
                      <button 
                        ...
                        className="gods:flex gods:items-center gods:gap-2 gods:px-3 gods:py-1.5 gods:bg-background gods:border gods:border-border hover:gods:border-primary/50 gods:rounded-md gods:text-sm gods:font-[family-name:var(--font-display)] gods:tracking-wider gods:transition-all !gods:outline-none"
                      >
                    ...
                    <div className="gods:p-5 gods:space-y-4">
                      <p className="gods:text-foreground/80 gods:leading-relaxed">
                        {ritual.description}
                      </p>

                      {ritual.receptacle && (
                        <div className="gods:bg-background/50 gods:border gods:border-border/50 gods:rounded-md gods:p-4 gods:flex gods:gap-3">
                          <Droplets size={16} className="gods:text-foreground/40 gods:shrink-0 gods:mt-0.5" />
                          <div>
                            <span className="gods:block gods:text-xs gods:font-[family-name:var(--font-display)] gods:tracking-widest gods:uppercase gods:text-foreground/50 gods:mb-1">
                              Réceptacle Courant
                            </span>
                            <p className="gods:text-sm gods:text-foreground/70 gods:leading-relaxed">
                              {ritual.receptacle}
                            </p>
                          </div>
                        </div>
                      ...
                      {ritual.note && (
                        <p className="gods:text-sm gods:italic gods:text-foreground/50">
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className="gods:fixed gods:top-1/2 gods:left-1/2 gods:-translate-x-1/2 gods:-translate-y-1/2 gods:z-[401] gods:w-[400px] gods:bg-popover gods:border gods:border-border gods:rounded-lg gods:shadow-2xl gods:p-6 !gods:outline-none gods:animate-in gods:fade-in gods:zoom-in-95">
            ...
            <div className="gods:mb-6">
              <p className="gods:text-sm gods:text-foreground/70 gods:mb-4">
                Sélectionnez le personnage qui doit apprendre ou oublier le rituel : <br/>
                <strong className="gods:text-primary gods:text-base gods:font-[family-name:var(--font-display)] gods:tracking-wide gods:mt-2 gods:block">
                  {selectedRitual?.name}
                </strong>
              </p>
            ...
            <div className="gods:flex gods:justify-end gods:gap-3">
              <button 
                ...
                className="gods:px-4 gods:py-2 gods:flex gods:items-center gods:gap-2 gods:text-sm gods:text-destructive hover:gods:bg-destructive/10 gods:rounded-md gods:transition-colors !gods:outline-none"
              >
                <Trash2 size={16} />
                Oublier
              </button>
              ...
              <button 
                ...
                className="gods:px-5 gods:py-2 gods:bg-primary gods:text-primary-foreground gods:text-sm gods:font-medium gods:rounded-md hover:gods:bg-primary/85 gods:transition-all gods:font-[family-name:var(--font-display)] gods:tracking-wider !gods:outline-none"
              >
                Ajouter au grimoire
              </button>
            </div>
